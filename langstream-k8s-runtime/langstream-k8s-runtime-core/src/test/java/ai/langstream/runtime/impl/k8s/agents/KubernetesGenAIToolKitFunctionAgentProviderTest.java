                    ...
                    configuration:
                        ...
                        messages:
                         - role: system
                           content: "Hello"
                """,
                "Found error on agent configuration (agent: 'chat', type: 'ai-chat-completions'). No ai service resource found in application configuration. One of vertex-configuration, hugging-face-configuration, open-ai-configuration, bedrock-configuration, ollama-configuration, rayllm-configuration, rayserve-configuration must be defined.");
